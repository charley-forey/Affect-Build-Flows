...
| Non-billable (relationship/setup/pre-NDA) | 10.0 | — |

> Entries 4–5 are substantial delivered work logged as non-billable because the NDA and
> Phase 1 scope are not yet agreed. **Worth revisiting** once the engagement is formalised
> — the tracker assessment and build kit are deliverables in their own right, and would
> otherwise fall inside D1's estimated 10–20 hrs.
