...
| Development (billable) | 30.75 | $3,843.75 |
| Mentoring (billable) | 0.0 | $0 |
| **Billable total** | **34.5** | **$4,312.50** |
...
|---|---|---|
| Budget | 20.0 | $2,500 |
| Consumed | 34.5 | $4,312.50 |
| **Remaining** | **−14.5** | **−$1,812.50** |
...
> line items were delivered by Aug 2 at ~22 hrs. Entries 16–18 are a second subject area
> (the PQP), two Power Automate flows, and the reporting layer over both — none of which was
> in the original twenty. **This needs a conversation with Cathal**: either bill it against
> the agreed 5 hrs/week ongoing cadence, or scope it as a second block. Flagged rather than
