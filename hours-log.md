...
| Development (billable) | 36.75 | $4,593.75 |
| Mentoring (billable) | 0.0 | $0 |
| **Billable total** | **40.5** | **$5,062.50** |
...
>
> **The number moved again on Aug 19.** It was 34.5 at the 08:23 update and is 40.5 now;
> entries 19 and 20 are the same day's later sessions. Any figure quoted to Cathal should be
