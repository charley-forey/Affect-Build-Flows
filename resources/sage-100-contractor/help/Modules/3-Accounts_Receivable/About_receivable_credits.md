<!-- Source: http://sage100contractorhelp.sagecre.com/help/sage100contractor/US/20_5/Content/Modules/3-Accounts_Receivable/About_receivable_credits.htm (Sage 100 Contractor help v20.5) -->
...
- When entering cash receipts, you can apply the credit invoice. [How?](Applying_credit_invoices_to_receivable_invoices.md)
...
[![Closed](http://sage100contractorhelp.sagecre.com/help/sage100contractor/US/20_5/Skins/Default/Stylesheets/Images/transparent.gif)To enter a credit invoice](javascript:void(0);)
...
|  | h | In the **Status** list, click the invoice status. [How?](About_receivable_invoice_status.md) |
|---|---|---|

|  | i | In the **Type** list, click the invoice type. [How?](About_receivable_invoice_types.md) |
|---|---|---|
...
[![Closed](http://sage100contractorhelp.sagecre.com/help/sage100contractor/US/20_5/Skins/Default/Stylesheets/Images/transparent.gif)To enter a credit invoice and apply it to an invoice](javascript:void(0);)
...
|  | i | In the **Status** list, enter the invoice status. [How?](About_receivable_invoice_status.md) |
|---|---|---|

|  | j | In the **Type** list, enter the invoice type. [How?](About_receivable_invoice_types.md) |
|---|---|---|
...
| Links to more information . . . [Entering credit invoices from 3-2 Receivable Invoices-Credits](Entering_credit_invoices_from_3-2_Receivable_Invoices-Credits.md) [Entering payments and applying credits to invoices simultaneously](Entering_payments_and_applying_credits_to_invoices_simultaneously.md) [Applying credit invoices to receivable invoices](Applying_credit_invoices_to_receivable_invoices.md) |
|---|
