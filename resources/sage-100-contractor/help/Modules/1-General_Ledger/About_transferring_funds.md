<!-- Source: http://sage100contractorhelp.sagecre.com/help/sage100contractor/US/20_5/Content/Modules/1-General_Ledger/About_transferring_funds.htm (Sage 100 Contractor help v20.5) -->
...
| Links to more information . . . [About clearing accounts](About_clearing_accounts.md) [Creating ledger accounts](Creating_ledger_accounts.md) [Entering clearing account transfers](Entering_clearing_account_transfers.md) [About bank reconciliation](About_bank_reconciliation.md) [About account ranges](About_account_ranges.md) |
|---|
