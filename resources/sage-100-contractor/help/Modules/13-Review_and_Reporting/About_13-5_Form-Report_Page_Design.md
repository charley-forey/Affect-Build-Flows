<!-- Source: http://sage100contractorhelp.sagecre.com/help/sage100contractor/US/20_5/Content/Modules/13-Review_and_Reporting/About_13-5_Form-Report_Page_Design.htm (Sage 100 Contractor help v20.5) -->
...
Note: Sometimes it is quicker to create a new form from an existing form if you only have to make a few changes or additions.
...
| Links to more information . . . [Creating new forms](Creating_new_forms.md) [Editing existing forms](Editing_existing_forms.md) [Creating new forms using existing forms](Creating_new_forms_using_existing_forms.md) [Previewing forms](Previewing_forms.md) |
|---|
