<!-- Source: http://sage100contractorhelp.sagecre.com/help/sage100contractor/US/20_5/Content/Modules/4-Accounts_Payable/Entering_open_credit_invoices.htm (Sage 100 Contractor help v20.5) -->
...
| Links to more information . . . [About payable invoice status](About_payable_invoice_status.md) [About payable invoice types](About_payable_invoice_types.md) [Options for saving payable invoices](Options_for_saving_payable_invoices.md) [Applying open credits to payable invoices](Applying_open_credits_to_payable_invoices.md) |
|---|
