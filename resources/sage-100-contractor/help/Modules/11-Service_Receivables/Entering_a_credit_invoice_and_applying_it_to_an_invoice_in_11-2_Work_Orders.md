<!-- Source: http://sage100contractorhelp.sagecre.com/help/sage100contractor/US/20_5/Content/Modules/11-Service_Receivables/Entering_a_credit_invoice_and_applying_it_to_an_invoice_in_11-2_Work_Orders.htm (Sage 100 Contractor help v20.5) -->
...
- When entering cash receipts, you can apply the credit invoice. (See links)
...
|  | a | In the **Order#** text box, enter the order number. |
|---|---|---|

|  | b | In the **Date** text box, enter the date of the client invoice. |
|---|---|---|

|  | c | In the **Client#** text box, enter a client number. |
|---|---|---|

|  | d | In the **Description** text box, enter a brief statement about the transaction. |
|---|---|---|

|  | e | In the **Job** text box, enter the job number, if this credit is for a job.(See links) |
|---|---|---|

|  | f | In the **Status** list, click the invoice status. (See links) |
|---|---|---|

|  | g | In the **Type** list, click the invoice type. |
|---|---|---|

|  | 3 | Click the **Invoice Details** tab. |
|---|---|---|

|  | a | In the **Reference#** text box, enter the receivable invoice number to which you want to apply the credit invoice. |
|---|---|---|
...
|  | 5 | Repeat step 4 for each item. |
|---|---|---|

|  | 6 | On the **File** menu, click **[Save]**. |
|---|---|---|

| Links to more information . . . [About service invoice status](About_service_invoice_status.md) [About service invoice types](About_service_invoice_types.md) |
|---|
