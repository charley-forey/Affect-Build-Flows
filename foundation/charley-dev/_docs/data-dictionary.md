...
65 gold tables, 179 measures across 2 semantic models, 215 DQ rules.
...
- **Report usage (Monthly Progress Report):** Billing & Retainage (3 visuals), Data Quality (2 visuals), Direct Costs & Vendors (4 visuals), Financial (9 visuals), Overview (7 visuals), Portfolio (5 visuals), Project Detail (3 visuals), Safety & Quality (2 visuals), Schedule & Quality (3 visuals), Scorecard (2 visuals), Source Coverage (2 visuals), Vendor Insurance (2 visuals)
