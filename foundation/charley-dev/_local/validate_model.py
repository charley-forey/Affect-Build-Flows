...
def qc_expected():
    ...
    E.update({
        ...
        "Avg Submittal Turnaround": lambda c, s: _avg(R(c, "fct_QcSubmittal", s, false("IsOpen")), "TurnaroundDays"),
        "Median Submittal Turnaround": lambda c, s: (lambda v: __import__("statistics").median(v) if v else None)(
