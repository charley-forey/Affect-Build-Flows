...
FROM (VALUES
    ...
    (1, 0, CAST(61.0 AS DOUBLE), CAST(NULL AS DOUBLE), CAST(NULL AS STRING), '> 60 days'),
    ...
    (3, 3, CAST(1.0 AS DOUBLE),  CAST(NULL AS DOUBLE), CAST(NULL AS STRING), '>= 100%'),
    (3, 2, CAST(0.5 AS DOUBLE),  CAST(1.0 AS DOUBLE),  CAST(NULL AS STRING), '50-99%'),
    (3, 0, CAST(NULL AS DOUBLE), CAST(0.5 AS DOUBLE),  CAST(NULL AS STRING), '< 50%'),

    -- 4 Change Orders - age of oldest unapproved CO, in days
    (4, 3, CAST(NULL AS DOUBLE), CAST(46.0 AS DOUBLE), CAST(NULL AS STRING), '<= 45 days'),
    (4, 2, CAST(46.0 AS DOUBLE), CAST(61.0 AS DOUBLE), CAST(NULL AS STRING), '46-60 days'),
    (4, 0, CAST(61.0 AS DOUBLE), CAST(NULL AS DOUBLE), CAST(NULL AS STRING), '> 60 days'),

    -- 5 Safety Incidents - recordable incidents in the period
    (5, 3, CAST(0.0 AS DOUBLE),  CAST(1.0 AS DOUBLE),  CAST(NULL AS STRING), '0'),
    (5, 2, CAST(1.0 AS DOUBLE),  CAST(2.0 AS DOUBLE),  CAST(NULL AS STRING), '1'),
    (5, 0, CAST(2.0 AS DOUBLE),  CAST(NULL AS DOUBLE), CAST(NULL AS STRING), '>= 2'),
    ...
    (6, 3, CAST(NULL AS DOUBLE), CAST(0.05 AS DOUBLE), CAST(NULL AS STRING), '< 5%'),
    (6, 2, CAST(0.05 AS DOUBLE), CAST(0.10 AS DOUBLE), CAST(NULL AS STRING), '5-9%'),
    (6, 0, CAST(0.10 AS DOUBLE), CAST(NULL AS DOUBLE), CAST(NULL AS STRING), '>= 10%'),
    ...
    (7, 3, CAST(NULL AS DOUBLE), CAST(1.0 AS DOUBLE),  CAST(NULL AS STRING), '<= 0 days'),
    (7, 2, CAST(1.0 AS DOUBLE),  CAST(15.0 AS DOUBLE), CAST(NULL AS STRING), '1-14 days'),
    (7, 0, CAST(15.0 AS DOUBLE), CAST(NULL AS DOUBLE), CAST(NULL AS STRING), '>= 15 days'),
    ...
    (8, 3, CAST(NULL AS DOUBLE), CAST(6.0 AS DOUBLE),  CAST(NULL AS STRING), '< 6 days'),
    (8, 2, CAST(6.0 AS DOUBLE),  CAST(11.0 AS DOUBLE), CAST(NULL AS STRING), '6-10 days'),
    (8, 0, CAST(11.0 AS DOUBLE), CAST(NULL AS DOUBLE), CAST(NULL AS STRING), '>= 11 days'),
